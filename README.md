...
- For one character/timbre, prefer two or more short single-syllable samples with measured pitch offsets so the app can choose a stable layer before pitch shifting.
